...
VALUES
('DOC001', 'Melissa Jacqueline', 'Mendieta', 'González', 'melissa.mendieta@sbd.edu.mx', 'Activo', 'Docente titular'),
('DOC002', 'Andrea', 'Infante', 'Sánchez', 'andrea.infante@sbd.edu.mx', 'Activo', 'Docente titular'),
('DOC003', 'Yazmany Jahaziel', 'Guerrero', 'Ceja', 'yazmany.guerrero@sbd.edu.mx', 'Activo', 'Docente titular'),
('DOC004', 'Paola Fernanda', 'Ramírez', 'Luna', 'paola.ramirez@sbd.edu.mx', 'Activo', 'Docente de primaria'),
('DOC005', 'Miguel Ángel', 'Torres', 'Salinas', 'miguel.torres@sbd.edu.mx', 'Activo', 'Docente de primaria'),
...
('DOC008', 'Fernanda Sofía', 'Castillo', 'Nava', 'fernanda.castillo@sbd.edu.mx', 'Activo', 'Docente de primaria');
...
VALUES
('ALU001', 'Ángel Esaú', 'Hernández', 'García', '2019-03-15', 'angel.hernandez@sbd.edu.mx', 'Activo', 'Primer grado'),
('ALU002', 'Valeria', 'Durón', 'Pansza', '2019-07-22', 'valeria.duron@sbd.edu.mx', 'Activo', 'Primer grado'),
('ALU003', 'Edwin Uriel', 'Santiago', 'Camacho', '2018-10-28', 'edwin.santiago@sbd.edu.mx', 'Activo', 'Segundo grado'),
('ALU004', 'Grecia Isabel', 'González', 'García', '2018-05-19', 'grecia.gonzalez@sbd.edu.mx', 'Activo', 'Segundo grado'),
...
('ALU007', 'Alicia Christyna', 'Martínez', 'Parra', '2016-08-14', 'alicia.martinez@sbd.edu.mx', 'Activo', 'Cuarto grado'),
('ALU008', 'Jorge Gael', 'Rodríguez', 'Ibarra', '2016-02-26', 'jorge.rodriguez@sbd.edu.mx', 'Activo', 'Cuarto grado'),
('ALU009', 'Carolina', 'Garza', 'Ortiz', '2015-06-08', 'carolina.garza@sbd.edu.mx', 'Activo', 'Quinto grado'),
('ALU010', 'Aurora del Carmen', 'Piedra', 'Alegría', '2015-12-17', 'aurora.piedra@sbd.edu.mx', 'Activo', 'Quinto grado'),
('ALU011', 'Carlos Manuel', 'Valerio', 'Rios', '2014-05-23', 'carlos.valerio@sbd.edu.mx', 'Activo', 'Sexto grado'),
('ALU012', 'Mariana Sofía', 'López', 'Herrera', '2014-11-09', 'mariana.lopez@sbd.edu.mx', 'Activo', 'Sexto grado');
